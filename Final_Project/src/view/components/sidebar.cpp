/**
 * @file view/components/sidebar.cpp
 * @brief Sidebar implementation (C++17)
 *
 * MVC Role: VIEW — builds the tree view and wires selection changes
 * to the Controller (ActionHandlers::onTreeSelectionChanged).
 */
...
GtkWidget* Sidebar::create(EventViewerContext* ctx) {
    ...
    // Wire selection change → Controller
